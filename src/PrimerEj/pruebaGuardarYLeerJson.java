...
public class pruebaGuardarYLeerJson {
...
//Respuesta: se guarda en la ruta: "usuario.json", es decir, en el mismo paquete en el que se está ejecutando este rpograma.
